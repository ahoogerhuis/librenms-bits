"""service_status_wuauserv check.

Invokes the Get-WuauservStatus JEA function (see the WinrmProbeJEA
module, WINRM_JEA_WINDOWS.md) -- a zero-parameter function whose body
is hardcoded to (Get-Service -Name wuauserv).Status and returns
compact JSON.
...
CHECK_FUNCTION = "Get-WuauservStatus"
